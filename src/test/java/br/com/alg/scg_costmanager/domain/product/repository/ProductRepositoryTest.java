...
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) // Usa o banco configurado (ex: Testcontainers) em vez do H2 embutido
// Se quiser usar H2 embutido, mude para: @AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.ANY)
class ProductRepositoryTest {
    ...
    @Test
    @DisplayName("INCLUIR: Deve salvar um produto final com receita e ingredientes no banco de dados")
    ...
    @Test
    @DisplayName("ALTERAR: Deve atualizar o nome de um produto")
    void update_productName_shouldBeReflectedInDatabase() {
        // -- ARRANGE --
    ...
    @Test
    @DisplayName("DELETAR: Deve remover um produto do banco de dados")
    ...
    @Test
    @DisplayName("DELETAR: Deve remover um produto final e sua receita em cascata")
